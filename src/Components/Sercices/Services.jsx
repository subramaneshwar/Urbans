  ...
  return (
    <div style={{width:'100%'}}>
      <div style={{ height: '100vh', width: '100%' }}>
        <img src="https://www.urbansciencemep.com/_next/static/images/fire%20page-52ef6b18761477396076c7828f67e90a.jpg" alt="" height='100%' />
      </div>
      <div style={{ height: '100vh', width: '100%', display: 'flex', alignItems: 'center', flexDirection: 'column',paddingBottom:"80px" }}>
        <h1>Services</h1>
